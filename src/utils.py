...
#Changing Hash to Reecoin's X13 Function
HashX11 = lambda x: x13.getPoWHash(x)
...
def hash_160_to_address(h160, addrtype = 60): #chainparams.cpp L69
...
logger = logging.getLogger('electrum-reecoin')
